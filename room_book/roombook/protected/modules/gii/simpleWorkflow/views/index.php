...
<p>This generator converts a workflow created by <a href="http://www.yworks.com/en/products_yed_download.html"
                                                    target="yed">yEd Graph Editor</a>,
    into a workflow ready to be used by your <a href="http://www.yiiframework.com/extension/simpleworkflow/"
                                                target="sw">simpleWorkflow extension</a>.</p>
...
<?php if ($model->getWorkFilename() != null): ?>
    <div class="row" style="margin-bottom: 20px;margin-top: 20px;">
        Currently Working on file <span
                style="background-color:yellow;font-weight: bold;"> <?php echo Chtml::encode($model->getWorkFilename()); ?> </span>
    </div>
<?php endif; ?>
<div class="row">
    <?php
